          ...
          <div class="addr-list-wrap">
              ...
              <ul>
                <li v-for="(item,index) in addressListFilter" :key="index" :class="{'check':checkedIndex==index}" @click="checkedIndex=index">
                  ...
                  <div class="addr-opration addr-del">
                    <a
                      href="javascript:;"
                      class="addr-del-btn" @click="delAddressConfirm(item.addressId)"
                    >
                  ...
                  <p class="addr-opration" v-show="!item.isDefault">
                    <a
                      href="javascript:;"
                      class="addr-set-default-btn"  @click ="setDefault(item.addressId)" 
                    ><i>Set default</i></a>
                  </p>
            ...
            <div class="shipping-addr-more">
              <a
                ...
                href="javascript:;" @click="expand" :class="{'open':limit>3}"
              >
                more
                <i class="i-up-down">
